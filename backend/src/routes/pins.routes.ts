...
router.put('/:id', validateBody(updatePinSchema), (req, res, next) => void pinsController.updatePin(req as any, res, next));
router.delete('/:id', (req, res, next) => void pinsController.deletePin(req, res, next));
// eslint-disable-next-line @typescript-eslint/no-unsafe-argument
router.post('/:id/rate', validateBody(ratePinSchema), (req, res, next) => void pinsController.ratePin(req as any, res, next));
// eslint-disable-next-line @typescript-eslint/no-unsafe-argument
router.post('/:id/report', validateBody(reportPinSchema), (req, res, next) => void pinsController.reportPin(req as any, res, next));
