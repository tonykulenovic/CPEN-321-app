...
router.get('/', (req, res, next) => void badgeController.getAllBadges(req, res, next));

// User routes for badge interaction
// GET /api/badges/user/earned - Get user's earned badges
router.get('/user/earned', (req, res, next) => void badgeController.getUserBadges(req, res, next));

// GET /api/badges/user/available - Get badges user hasn't earned yet
router.get('/user/available', (req, res, next) => void badgeController.getAvailableBadges(req, res, next));

// GET /api/badges/user/progress - Get user's badge progress
router.get('/user/progress', (req, res, next) => void badgeController.getBadgeProgress(req, res, next));

// GET /api/badges/user/stats - Get user's badge statistics
router.get('/user/stats', (req, res, next) => void badgeController.getBadgeStats(req, res, next));
